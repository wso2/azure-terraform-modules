...
resource "azurerm_api_management_api_operation_policy" "api_management_api_operation_policy_primary" {
  api_name            = azurerm_api_management_api_operation.api_management_api_operation_primary.api_name
  api_management_name = azurerm_api_management_api_operation.api_management_api_operation_primary.api_management_name
  resource_group_name = var.resource_group_name
  operation_id        = azurerm_api_management_api_operation.api_management_api_operation_primary.operation_id
