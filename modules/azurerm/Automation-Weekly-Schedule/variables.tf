...
variable "automation_weekly_schedule_name" {
...
variable "automation_weekly_schedule_frequency" {
  default     = "Week"
  description = "The frequency of the schedule"
  type        = string
}

variable "automation_weekly_schedule_intervel" {
  description = "The number of frequencys between runs"
  type        = string
}

variable "automation_weekly_schedule_start_time" {
  description = "Start time of the schedules"
  type        = string
}

variable "automation_weekly_schedule_description" {
  description = "A description for the schedule"
  type        = string
}

variable "automation_weekly_schedule_timezone" {
  description = "The timezone of the start time"
  type        = string
}

variable "automation_weekly_schedule_week_days" {
